...
*
* game_is_over checs if the game is over
*
*@date 15/01/2019
*@author: Instructors
*
...
/**
* @brief return game's link array
* @date 11/03/20
* @author: Javier Lopez
*
* @param game
...
/***
* @brief Checks if the object can be taken based on its dependencies
*
* @date 06/05/20
* @author Gabriela Trabajo de Rada
*
* @param game pointer to the game
* @param id identifier of the object you want to take
* @return if it can be taken, returns "OK". If not, returns "ERROR"
*/
STATUS game_object_canbetakenDep(Game *game, Id id);
/***
* @brief Checks if the object can be taken based on its incompatibilities
*
* @date 06/05/20
* @author Gabriela Trabajo de Rada
*
...
/***
* @brief Checks if the object has dependencies or not to drop it with its dependencies or not
*
* @date 06/05/20
* @author Gabriela Trabajo de Rada
*
* @param game pointer to the game
* @param id identifier of the object you want to drop
* @return the id of the object that is dependent on the checked object
*/
Id game_object_dropDep(Game *game, Id id);
/***
* @brief Changes the game over bool
*
* @date 09/05/20
* @author Guillermo Martin
*
* @param game pointer to the game
* @param BOOL over status
* @return status
*/
