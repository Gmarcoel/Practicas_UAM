...
/**
* @brief Returns an array with the id of the nodes connected to a given node. Allocates mem
* @param g The graph
...
/**
* @brief Prints in the file pf the data of a graph, returning the number of printed charact
*
* The format to be followed is: print a line by node with the information associated with t
