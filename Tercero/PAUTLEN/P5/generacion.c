...
void escribir_subseccion_data(FILE *fpasm)
{
    ...
    fprintf(fpasm, "; escribir_cabecera_data:\n");
...
void sumar(FILE *fpasm, int es_variable_1, int es_variable_2)
{
    ...
    fprintf(fpasm, "\n\t; sumar(es_variable_1=%i, es_variable_2=%i)\n", es_variable_1, es_variable_2);
...
void o(FILE *fpasm, int es_variable_1, int es_variable_2)
{
    ...
    fprintf(fpasm, "\n\t; o(es_variable_1=%i, es_variable_2=%i):\n", es_variable_1, es_variable_2);
...
void y(FILE *fpasm, int es_variable_1, int es_variable_2)
{
    ...
    fprintf(fpasm, "\n\t; y(es_variable_1=%i, es_variable_2=%i):\n", es_variable_1, es_variable_2);
...
void ifthenelse_inicio(FILE *fpasm, int exp_es_variable, int etiqueta)
{
    if (fpasm == NULL)
    {
        perror("ERROR: \"ifthenelse_inicio()\"");
        return;
    }
...
void ifthenelse_fin_then(FILE *fpasm, int etiqueta)
{
    ...
    fprintf(fpasm, "\tjmp func_if_else_final%i\n", etiqueta);
    fprintf(fpasm, "func_if_final%i:\n", etiqueta);
}
/*
...
void ifthenelse_fin(FILE *fpasm, int etiqueta)
{
    ...
    fprintf(fpasm, "func_if_else_final%d:\n", etiqueta);
}
/*
