...
parametros_funcion: parametro_funcion resto_parametros_funcion {fprintf(out, ";R23:\t23<parametros_funcion> ::= <parametro_funcion> <resto_parametros_funcion>\n");} 
...
asignacion: identificador TOK_ASIGNACION exp {fprintf(out, ";R43:\t<asignacion> ::= <identificador> = <exp> \n");} 
    | elemento_vector TOK_ASIGNACION exp {fprintf(out, ";R44:\t<asignación> ::= <elemento_vector> = <exp>\n");};
...
exp: exp TOK_MAS exp {fprintf(out, ";R72:\t<exp> ::= <exp> + <exp>\n");}             
    ...
    | TOK_NOT exp {fprintf(out, ";R79:\t<exp> ::= <exp> ! <exp>\n");}            
    | identificador {fprintf(out, ";R80:\t<exp> ::= <identificador>\n");}             
    | constante {fprintf(out, ";R81:\t<exp> ::= <constante_entera>\n");}              
...
constante_entera: numero {fprintf(out, ";R104:\t<constante_entera> ::= <numero>\n");};

numero: TOK_CONSTANTE_ENTERA {fprintf(out, ";R105:\t<numero> ::= <digito>\n");}
